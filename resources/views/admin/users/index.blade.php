...
@section('container')
    <div class="p-4 sm:ml-64">
        <div class="p-4 border border-gray-200  rounded-lg dark:border-gray-700">
            ...
            <h1 class="mb-1 text-md text-center font-bold dark:text-white">User List</h1>
                ...
                <div class="relative">
                    ...
                    <form action="/admin/users">
                        <input type="text" id="table-search"
                            ...
                            placeholder="Search user and enter" name="search" value="{{ request('search') }}">
                    </form>
                </div>
            </div>
                    ...
                    @foreach ($users as $user)
                        <tr
                            ...
                            <th scope="row"
                                class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                {{-- {{ $user->role }} --}}
                                <form action='/admin/users/update/{{ $user->id }}' method="post" class="flex gap-3">
                                    @csrf
                                    @method('PUT')
                                ...
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    <div class="p-4 md:p-5 text-center">
                                        ...
                                        <form action="/users/delete/{{ $user->id }}" method="POST">
                                            ...
                                            <button data-modal-hide="popup-modal-user-{{ $user->id }}" type="submit"
                                                class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                                                Yes, I'm sure
                                            </button>
                                        </form>
                                        <button data-modal-hide="popup-modal-user-{{ $user->id }}" type="button"
                        ...
                        <!-- Main modal -->
                        <div id="static-modal-{{ $user->id }}" data-modal-backdrop="static" tabindex="-1"
                            aria-hidden="true"
                            class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                            <div class="relative p-4 w-full max-w-2xl max-h-full">
                                ...
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    <div class="p-4 md:p-5 space-y-4">
                                        <img class="h-40" src="{{ asset('storage/' . $user->image) }}" alt="">
                                    ...
                                    <div
                                        ...
                                        <button data-modal-hide="static-modal-{{ $user->id }}" type="button"
