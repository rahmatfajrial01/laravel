...
@section('auth')
    <section class="bg-slate-100 dark:bg-gray-900 min-h-screen flex items-center justify-center ">
        ...
        <form action="/login" method="POST" class="max-w-sm w-full bg-white dark:bg-gray-800 p-5 rounded-xl border">
            @csrf
            ...
            <p class="text-sm dark:text-white">Not have an account ? <a class="text-blue-500" href="/register">register
                    !</a></p>
        </form>
    </section>
@endsection
